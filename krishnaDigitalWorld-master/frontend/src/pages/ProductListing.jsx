      ...
      <div className="flex gap-6">
        ...
        <main className="flex-1 min-w-0">
          {loading ? (
            ...
            {products.map((product, index) => (<Link key={product.id} to={`/product/${product.slug || product.id}`} className="block focus:outline-none focus:ring-2 focus:ring-accent rounded-lg">
