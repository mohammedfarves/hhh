...
const TermsConditions = () => {
    ...
    const sections = [
        ...
        },
        {
            ...
            points: [
                ...
                "Product specifications may vary from images and descriptions",
        ...
        },
        {
            ...
            points: [
                `All prices are listed in ${shopInfo?.currency || 'INR'} (Indian Rupees)`,
                ...
                "All transactions are processed securely through our payment gateways",
                "Additional taxes may apply as per government regulations"
            ],
        ...
        },
        {
            ...
            points: [
                ...
                "Return requests must be initiated within the specified time period",
        ...
        },
        {
            ...
            points: [
                ...
                `${shopInfo?.shopName || "Sri Krishna Home Appliances"} will assist customers with warranty claims`,
                "Warranty terms and conditions vary by product and manufacturer",
                "Proof of purchase is required for warranty claims",
                "Service requests must be made through authorized channels only"
            ],
        ...
        },
        {
            ...
            points: [
                ...
                "To use our services only for lawful purposes"
            ],
    ...
    const legalSections = [
        {
            ...
            description: `${shopInfo?.shopName || "Sri Krishna Home Appliances"} is not liable for indirect, incidental, or consequential damages arising from the use of our products or services. Our liability is limited to the maximum extent permitted by law.`,
            icon: Shield
        },
        {
            title: "Changes to Terms",
            description: `We reserve the right to update or modify these Terms & Conditions at any time. Changes will be effective immediately upon posting on this page. Your continued use of our services after any changes constitutes acceptance of those changes. We recommend checking this page periodically for updates.`,
            icon: AlertCircle
        },
        {
            title: "Governing Law & Jurisdiction",
            description: `These Terms & Conditions are governed by the laws of India. Any disputes shall be subject to the jurisdiction of courts in ${shopInfo?.city || 'Nagapattinam'}, ${shopInfo?.state || 'Tamil Nadu'}.`,
            icon: Gavel
        },
        {
            title: "Intellectual Property",
            description: `All content on our website and marketing materials, including logos, text, images, and designs, are the property of ${shopInfo?.shopName || "Sri Krishna Home Appliances"} or its licensors. You may not use, reproduce, or distribute any content without our prior written permission.`,
            icon: FileText
        }
    ];
    ...
    const handleEmailClick = () => {
        ...
        if (email) {
            ...
            const body = encodeURIComponent(`Dear Legal Team,\n\nI have a question regarding your Terms & Conditions:\n\n[Please describe your inquiry here]\n\nThank you.`);
            window.location.href = `mailto:${email}?subject=${subject}&body=${body}`;
        } else {
            alert("Email address not available. Please contact us via phone or visit our store.");
        }
    };
    ...
    const handlePhoneClick = () => {
        ...
        if (phoneNumber) {
            ...
            alert("Phone number not available. Please send us an email or visit our store.");
        }
    };

    // Get primary location for jurisdiction
    const getJurisdiction = () => {
        if (shopInfo?.city && shopInfo?.state) {
            return `${shopInfo.city}, ${shopInfo.state}`;
        } else if (shopInfo?.city) {
            return `${shopInfo.city}, Tamil Nadu`;
        } else if (shopInfo?.state) {
            return `Nagapattinam, ${shopInfo.state}`;
        }
                            ...
                            <div className="bg-card rounded-2xl p-6 border border-border hover:border-accent/50 transition-all duration-300">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <p className="text-muted-foreground text-sm md:text-md mb-3">
                        ...
                        <div className="max-w-4xl mx-auto">
                            <div className="text-center mb-14" data-aos="fade-up">
                                ...
                                <p className="text-muted-foreground max-w-xl mx-auto">
                                    Comprehensive guidelines for using our services at {shopInfo?.shopName || "our store"}
                                </p>
                            </div>
                                ...
                                {sections.map((section, index) => {
                                    ...
                                    return (
                                        <div key={section.title} data-aos="fade-up" data-aos-delay={index * 100} 
                                             className="group relative bg-card rounded-2xl p-6 md:p-8 border border-border/60 hover:border-transparent hover:shadow-2xl transition-all duration-500 overflow-hidden">
                                            ...
                                            <div className="bg-background rounded-xl p-6 border border-border">
                                                <ul className="space-y-3">
                                                    {section.points.map((point, i) => (
                                                        <li key={i} className="flex text-sm md:text-md items-start gap-3">
                            ...
                            <div className="mt-14">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    {legalSections.map((section, index) => {
                                        ...
                                        return (
                                            <div key={section.title} data-aos="fade-up" data-aos-delay={index * 100} 
                                                 className="bg-card rounded-2xl p-6 border border-border hover:border-accent/50 transition-all duration-300">
                    ...
                    <div className="container mx-auto px-4 relative z-10">
                        <div className="max-w-3xl mx-auto text-center" data-aos="zoom-in">
                            ...
                            <p className="text-accent-foreground/80 text-sm md:text-lg mb-8 max-w-xl mx-auto">
                                If you have any questions about our terms or policies, our team at {shopInfo?.shopName || "Sri Krishna Home Appliances"} is here to help.
                            </p>
