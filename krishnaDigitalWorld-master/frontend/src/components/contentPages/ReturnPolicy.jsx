...
import { XCircle, Package, ShieldCheck, Home, Phone, AlertTriangle, CheckCircle, Users, Target, Star, Shield, Zap, Mail, MapPin, ExternalLink, Calendar, Clock, FileText, DollarSign } from "lucide-react";
...
const ReturnPolicy = () => {
    ...
    const policyDetails = [
        ...
        },
        {
            ...
            points: [
                ...
                "Complete verification before delivery completion"
            ],
        ...
        },
        {
            ...
            icon: Shield,
            description: "Comprehensive manufacturer warranty coverage.",
            points: [
        ...
        },
        {
            ...
            icon: Users,
            description: "Direct store-based assistance available.",
            points: [
        ...
        },
        {
            ...
            points: [
                "Original invoice for all purchases",
    ...
    const customerSupport = [
        `Visit ${shopInfo?.shopName || "our store"} for any concerns`,
    ...
    const deliverySteps = [
        ...
        },
        {
            number: "5",
            title: "Documentation",
            description: "Receive all purchase documents"
        },
        {
            number: "6",
            title: "Installation Scheduling",
            description: "Schedule installation if required"
        }
    ];
    ...
    const handleEmailClick = () => {
        ...
        if (email) {
            const subject = encodeURIComponent("Return Policy Query");
            const body = encodeURIComponent(`Hello,\n\nI have a question regarding your return policy:\n\n[Please describe your query here]\n\nProduct Details:\n\nThank you.`);
    ...
    const formatBusinessHours = () => {
        if (!shopInfo?.businessHours) return "9 AM - 9 PM";
                    ...
                    <div className="container mx-auto px-4 relative z-10">
                        <div className="max-w-4xl mx-auto text-center">
                            ...
                            <p data-aos="fade-up" data-aos-delay="200" className="text-sm md:text-xl text-muted-foreground max-w-2xl mx-auto">
                                Customer satisfaction and product quality are our top priorities at {shopInfo?.shopName || "Sri Krishna Home Appliances"}. 
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-muted-foreground text-justify mb-3">
                                            We do not accept returns for any products. All sales are final at {shopInfo?.shopName || "our store"}. 
                        ...
                        <div className="max-w-6xl mx-auto">
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                {policyDetails.map((policy, index) => {
                                    ...
                                    return (
                                        <div key={policy.title} data-aos="fade-up" data-aos-delay={index * 100} 
                ...
                <section className="py-10 md:py-28 bg-secondary/30">
                    <div className="container mx-auto px-4">
                        <div className="text-center mb-14" data-aos="fade-up">
                            ...
                            <p className="text-muted-foreground max-w-xl mx-auto">
                                Why returns are not needed with our products at {shopInfo?.shopName || "Sri Krishna Home Appliances"}
                            </p>
                        </div>
                            ...
                            <div data-aos="fade-up" className="bg-card rounded-2xl p-6 md:p-8 border border-border hover:border-accent/50 transition-all duration-300">
                                ...
                                <div className="space-y-8">
                                    <p className="text-muted-foreground">
                                        Every product at {shopInfo?.shopName || "Sri Krishna Home Appliances"} undergoes multiple levels of 
                ...
                <section className="py-20">
                    <div className="container mx-auto px-4">
                        <div className="text-center mb-8 md:mb-14" data-aos="fade-up">
                            ...
                            <p className="text-muted-foreground max-w-xl mx-auto">
                                See and verify your product before acceptance at {shopInfo?.shopName || "our store"}
                            </p>
                        </div>
                                    ...
                                    <div>
                                        ...
                                        <div className="p-4 bg-card rounded-xl border border-border">
                                            <p className="text-foreground text-sm text-justify">
                                                ...
                                                no return or replacement will be allowed at {shopInfo?.shopName || "our store"}.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                ...
                <section className="py-10 md:py-28 bg-secondary/30">
                    <div className="container mx-auto px-4">
                        <div className="text-center mb-14" data-aos="fade-up">
                            ...
                            <p className="text-muted-foreground max-w-xl mx-auto">
                                We're here to help with any concerns at {shopInfo?.shopName || "our store"}
                            </p>
                        </div>
                                    ...
                                    <div>
                                        ...
                                        <div className="space-y-6">
                                            <button 
                                                ...
                                                className="w-full flex items-center gap-4 p-4 bg-background rounded-xl border border-border hover:border-accent/50 transition-all duration-300 cursor-pointer text-left"
                                            >
                                                <div className="inline-flex items-center justify-center w-10 h-10 rounded-xl bg-accent/10">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-muted-foreground text-sm">
                                                        ...
                                                        {primaryLocation?.address || shopInfo?.address || "Address not specified"}
                                                    </p>
                                            ...
                                            >
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-accent hover:text-accent/80 transition-colors">
                                                        {shopInfo?.supportPhone || shopInfo?.phone || "Contact Us"}
                                                    </p>
                                                    {shopInfo?.alternatePhone && (
                                                        <p className="text-xs text-muted-foreground mt-1">Alternate: {shopInfo.alternatePhone}</p>
                                                    )}
                                                </div>
                                            </button>
                                            {shopInfo?.email && (
                                                ...
                                                >
                                                    ...
                                                    <div>
                                                        <p className="font-heading font-semibold text-foreground mb-1">Email Support</p>
                                                        <p className="text-accent hover:text-accent/80 transition-colors break-all">
                                                            {shopInfo?.supportEmail || shopInfo?.email}
                                                        </p>
                                                    </div>
                                                </button>
                                            )}
                                        ...
                                        <div className="mt-6 p-4 bg-card rounded-xl border border-border">
                                            <p className="text-foreground text-sm">
                                                <strong className="font-heading text-accent">Store Hours:</strong> Monday to Saturday: {formatBusinessHours()}, 
                                                Sunday: 10 AM - 6 PM
                                            </p>
                                        </div>
                                    </div>
                    ...
                    <div className="container mx-auto px-4 relative z-10">
                        <div className="max-w-3xl mx-auto text-center" data-aos="zoom-in">
                            ...
                            <p className="text-accent-foreground/80 text-sm md:text-lg mb-8 max-w-xl mx-auto">
                                Our quality assurance and open box delivery ensure you get perfect products every time at {shopInfo?.shopName || "Sri Krishna Home Appliances"}.
                            </p>
