...
import { Briefcase, Target, Award, CheckCircle, Clock, MapPin, Phone, Mail, DollarSign, TrendingUp, HeartHandshake, Zap, ExternalLink } from "lucide-react";
        ...
        switch (method.method) {
            ...
            case 'call':
                if (shopInfo?.phone) {
                    ...
                    alert("Please contact us via email for career opportunities.");
                }
                break;
            case 'email':
                const email = shopInfo?.supportEmail || shopInfo?.email;
                if (email) {
                    const subject = encodeURIComponent("Job Application - Sales Person Position");
                    const body = encodeURIComponent(`Dear Hiring Manager,\n\nI am interested in applying for the Sales Person position at your store.\n\nPlease find my resume attached.\n\nThank you,\n[Your Name]`);
                    window.location.href = `mailto:${email}?subject=${subject}&body=${body}`;
                } else {
                    alert("Please visit our store or call us for career opportunities.");
                }
                break;
        }
    };
                    ...
                    <div className="container mx-auto px-4 relative z-10">
                        <div className="max-w-4xl mx-auto text-center">
                            ...
                            <h1 data-aos="fade-up" data-aos-delay="100" className="font-heading text-3xl md:text-6xl font-bold text-foreground mb-6 leading-tight">
                                ...
                                <span className="text-accent">{shopInfo?.shopName || "Sri Krishna Home Appliances"}</span>
                            </h1>
                    ...
                    <div className="container mx-auto px-4">
                        ...
                        <div className="max-w-4xl mx-auto">
                            {jobOpenings.map((job, index) => (
                                <div key={job.title} data-aos="fade-up" data-aos-delay={index * 100} 
                                    className="bg-card rounded-2xl p-6 md:p-8 border border-border hover:border-accent/50 transition-all duration-300 shadow-sm">
                                        ...
                                        <div>
                                            ...
                                            <div className="flex flex-wrap gap-2 mb-4 justify-center md:justify-start">
                                                ...
                                                <span className="inline-flex items-center gap-1 px-3 py-1.5 rounded-full bg-purple-500/10 text-purple-600 font-medium text-xs">
                                                    ...
                                                    {primaryLocation?.name || job.location}
                                                </span>
                                            </div>
                                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
                            {applyMethods.map((method, index) => {
                                ...
                                return (
                                    <button 
                                        key={method.title} 
                                        onClick={() => handleApply(method)}
                                        data-aos="fade-up" 
                                        data-aos-delay={index * 100} 
                                        className="group relative bg-card rounded-2xl p-6 border border-border/60 hover:border-transparent hover:shadow-2xl transition-all duration-500 overflow-hidden text-left w-full"
                                    >
                    ...
                    <div className="container mx-auto px-4 relative z-10">
                        <div className="max-w-3xl mx-auto text-center" data-aos="zoom-in">
                            ...
                            <p className="text-accent-foreground/80 text-lg mb-8 max-w-xl mx-auto">
                                Join our growing team and build a rewarding career with {shopInfo?.shopName || "Sri Krishna Home Appliances"}.
                            </p>
                            ...
                            {!shopInfo?.phone && (
                                <p className="text-accent-foreground/60 text-sm mt-4">
                                    Call option not available. Please visit our store for career opportunities.
                                </p>
                            )}
                        </div>
                    </div>
