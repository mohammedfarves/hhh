...
import { AlertTriangle, Package, Shield, Wrench, Home, Phone, Mail, XCircle, CheckCircle, DollarSign, Users, Target, Star, Calendar, MapPin, ExternalLink, Clock, FileText } from "lucide-react";
...
const RefundPolicy = () => {
    ...
    const policyPoints = [
        {
            ...
            details: [
                "No refunds after order placement or payment",
        ...
        },
        {
            ...
            description: "All products are delivered with open box delivery for verification.",
            details: [
                ...
                "Complete verification before signing delivery receipt"
            ],
        ...
        },
        {
            ...
            details: [
                ...
                "Installation charges may apply for certain products"
            ],
        ...
        },
        {
            ...
            description: "Comprehensive after-sales service support.",
            details: [
                "Service requests processed within 24-48 hours",
                "Brand-authorized service technicians",
                "Service available during store working hours",
                "Bring original purchase documents for service"
            ],
        ...
        },
        {
            icon: FileText,
            title: "Documentation",
            description: "Important documents for reference.",
            details: [
                "Keep original invoice safely",
                "Warranty card must be filled at time of purchase",
                "User manuals provided with all products",
                "Service contact details provided separately"
            ],
    ...
    const issueResolution = [
        `If you face any product issues, visit ${shopInfo?.shopName || "our shop"} directly`,
        "Our experienced staff will guide you with appropriate solutions",
        "We assist with warranty claims and service requests",
        "Technical support available during store working hours",
        "Product demos and explanations available at store for clarity",
        "Bring all relevant documents for faster resolution"
    ];
    ...
    const handleEmailClick = () => {
        ...
        if (email) {
            const subject = encodeURIComponent("Refund Policy Query");
            const body = encodeURIComponent(`Hello,\n\nI have a question regarding your refund policy:\n\n[Please describe your query here]\n\nOrder/Product Details:\n\nThank you.`);
                    ...
                    <div className="container mx-auto px-4 relative z-10">
                        <div className="max-w-4xl mx-auto text-center">
                            ...
                            <p data-aos="fade-up" data-aos-delay="200" className="text-sm md:text-xl text-muted-foreground max-w-2xl mx-auto">
                                At {shopInfo?.shopName || "Sri Krishna Home Appliances"}, we aim to provide genuine and quality products. 
                            ...
                            <div className="bg-card rounded-2xl p-6 border border-border hover:border-accent/50 transition-all duration-300">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-muted-foreground text-sm md:text-md text-justify mb-3">
                                            We do not provide refunds once an order is placed. Please verify all product details 
                                            carefully before completing your purchase at {shopInfo?.shopName || "our store"}.
                                        </p>
                                        <div className="flex items-center gap-2 text-sm text-muted-foreground">
                                            <Calendar className="w-4 h-4" />
                                            <span>Policy Effective Date: {getCurrentDate()}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="container mx-auto px-4">
                        <div className="text-center mb-14" data-aos="fade-up">
                            ...
                            <p className="text-muted-foreground max-w-xl mx-auto">
                                Understanding our terms and conditions at {shopInfo?.shopName || "our store"}
                            </p>
                        </div>
                        ...
                        <div className="max-w-6xl mx-auto">
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                {policyPoints.map((point, index) => {
                                    ...
                                    return (
                                        <div key={point.title} data-aos="fade-up" data-aos-delay={index * 100} 
                                             className="group relative bg-card rounded-2xl p-6 border border-border/60 hover:border-transparent hover:shadow-2xl transition-all duration-500 overflow-hidden">
                ...
                <section className="py-10 md:py-28 bg-secondary/30">
                    <div className="container mx-auto px-4">
                        <div className="text-center mb-14" data-aos="fade-up">
                            ...
                            <p className="text-muted-foreground max-w-xl mx-auto">
                                How we handle product concerns and support requests at {shopInfo?.shopName || "our store"}
                            </p>
                        </div>
                            ...
                            <div data-aos="fade-up" className="bg-card rounded-2xl p-6 md:p-8 border border-border hover:border-accent/50 transition-all duration-300">
                                ...
                                <div className="space-y-8">
                                    <p className="text-muted-foreground">
                                        ...
                                        please visit {shopInfo?.shopName || "our shop"} directly for assistance. Our experienced staff will 
                                    ...
                                    <div className="grid md:grid-cols-2 gap-8">
                                        <div className="space-y-4">
                                            ...
                                            <ul className="space-y-3">
                                                <li className="flex items-start gap-2">
                                                    ...
                                                    <span className="text-foreground">Original purchase receipt/invoice</span>
                                                </li>
                                                <li className="flex items-start gap-2">
                                                    <CheckCircle className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5"/>
                                                ...
                                                <li className="flex items-start gap-2">
                                                    <CheckCircle className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5"/>
                                                    <span className="text-foreground">Product serial number</span>
                                                </li>
                                            </ul>
                                        </div>
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <ul className="space-y-3">
                                                ...
                                                <li className="flex items-start gap-2">
                                                    <CheckCircle className="w-5 h-5 text-blue-500 flex-shrink-0 mt-0.5"/>
                                                    <span className="text-foreground">Installation support</span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    ...
                                    <div className="bg-card rounded-xl p-4 md:p-6 border border-border mt-6">
                                        ...
                                        <ul className="space-y-3">
                                            {issueResolution.map((point, index) => (
                ...
                <section className="py-20">
                    <div className="container mx-auto px-4">
                        <div className="text-center mb-14" data-aos="fade-up">
                            ...
                            <p className="text-muted-foreground max-w-xl mx-auto">
                                Why our products at {shopInfo?.shopName || "Sri Krishna Home Appliances"} don't require refunds
                            </p>
                        </div>
                    ...
                    <div className="container mx-auto px-4 relative z-10">
                        <div className="max-w-3xl mx-auto text-center" data-aos="zoom-in">
                            ...
                            <p className="text-accent-foreground/80 text-sm md:text-lg mb-8 max-w-xl mx-auto">
                                Visit {shopInfo?.shopName || "our store"} or contact us for product support, warranty claims, or any assistance.
                            </p>
                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 justify-center">
                                <button 
                                    onClick={handleStoreVisit}
                                    className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20 hover:bg-white/20 transition-colors group cursor-pointer"
                                >
                                    ...
                                    <p className="text-accent-foreground/80 text-sm">
                                        {primaryLocation?.name || shopInfo?.shopName || "Sri Krishna Home Appliances"}<br />
                                        {primaryLocation?.address ? (
                                            <span className="text-xs">{primaryLocation.address}</span>
                                        ) : shopInfo?.city ? (
                                            shopInfo.city
                                        ) : (
                                            "Nagapattinam"
                                    ...
                                    <div className="mt-2 flex items-center justify-center gap-1 text-xs text-accent-foreground/60">
                                ...
                                >
                                    ...
                                    <p className="text-accent-foreground/80 text-sm">
                                        {shopInfo?.supportPhone || shopInfo?.phone || "Contact Us"}
                                    </p>
                                    {shopInfo?.supportPhone && shopInfo?.phone && shopInfo.supportPhone !== shopInfo.phone && (
                                        <p className="text-xs text-accent-foreground/60 mt-1">Alternate: {shopInfo.phone}</p>
                                    )}
                                </button>
                                ...
                                >
                                    ...
                                    <p className="text-accent-foreground/80 text-sm break-all">
