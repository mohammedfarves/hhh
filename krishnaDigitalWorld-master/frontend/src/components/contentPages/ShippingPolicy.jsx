...
import { Truck, MapPin, Clock, Package, AlertCircle, Home, CheckCircle, Phone, Mail, Shield, Users, Target, Calendar, DollarSign, ExternalLink, Navigation } from "lucide-react";
...
const ShippingPolicy = () => {
    ...
    // Get store city for delivery area
    const deliveryCity = shopInfo?.city || "Nagapattinam";

    const deliveryInfo = [
        {
            icon: MapPin,
            title: "Delivery Area",
            description: `We deliver only within and around ${deliveryCity}`,
            details: [
                `Maximum delivery radius: Up to 30 km from ${deliveryCity}`,
                `Orders outside this area are not eligible for delivery`,
                `Delivery available in ${deliveryCity} and surrounding areas`
            ],
        ...
        },
        {
            ...
            details: [
                ...
                "Complete product inspection before acceptance"
            ],
        ...
        },
        {
            ...
            details: [
                ...
                "Direct interaction with our expert staff"
            ],
        ...
        },
        {
            ...
            description: "Transparent pricing for delivery",
            details: [
                shopInfo?.city === "Nagapattinam" ? "Free delivery within city limits" : "Contact us for delivery charges",
                "Nominal charges may apply for distant locations",
                "Installation charges may apply for certain products",
                "Clear pricing communicated before delivery"
            ],
        ...
        },
        {
            ...
            details: [
                ...
                "Advance scheduling for specific time slots",
                "Holiday delivery schedules announced in advance"
            ],
    ...
    const limitations = [
        ...
        "Weekend deliveries available for most locations",
        "Delivery timings may vary during festive seasons",
        "Large appliances may require special delivery arrangements"
    ];
    ...
    const openBoxDetails = [
        {
            ...
            items: [
                ...
                "Provide valid ID proof for delivery"
            ]
        },
        {
            icon: Shield,
    ...
    const handleEmailClick = () => {
        ...
        if (email) {
            const subject = encodeURIComponent(`Delivery Query - ${shopInfo?.shopName || "Store"}`);
                    ...
                    <div className="container mx-auto px-4 relative z-10">
                        <div className="max-w-4xl mx-auto text-center">
                            ...
                            <p data-aos="fade-up" data-aos-delay="200" className="text-sm md:text-xl text-muted-foreground max-w-2xl mx-auto">
                                At {shopInfo?.shopName || "Sri Krishna Home Appliances"}, we offer local delivery to ensure fast and safe service 
                                for our customers in and around {deliveryCity}.
                            </p>
                        </div>
                    </div>
                </section>
                            ...
                            <div className="bg-card rounded-2xl p-6 border border-border hover:border-accent/50 transition-all duration-300">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-muted-foreground md:text-md text-justify text-sm mb-3">
                                            We currently deliver only within 30km radius of {deliveryCity}. 
                    ...
                    <div className="container mx-auto px-4">
                        <div className="text-center mb-14" data-aos="fade-up">
                            ...
                            <p className="text-muted-foreground max-w-xl mx-auto">
                                Everything you need to know about our delivery service at {shopInfo?.shopName || "our store"}
                            </p>
                        </div>
                                ...
                                <div className="mt-8 pt-6 border-t border-border/50">
                                    ...
                                    <div className="bg-background rounded-lg p-4 border border-border">
                                        <p className="font-medium text-foreground mb-1">
                                            {primaryLocation?.name || shopInfo?.shopName || "Sri Krishna Home Appliances"}
                                        </p>
                ...
                <section className="py-10 md:py-20">
                    <div className="container mx-auto px-4">
                        <div className="text-center mb-14" data-aos="fade-up">
                            ...
                            <p className="text-muted-foreground max-w-xl mx-auto">
                                Ensuring you receive perfect products every time at {shopInfo?.shopName || "our store"}
                            </p>
                        </div>
                    ...
                    <div className="container mx-auto px-4 relative z-10">
                        <div className="max-w-3xl mx-auto text-center" data-aos="zoom-in">
                            ...
                            <p className="text-accent-foreground/80 text-sm md:text-lg mb-8 max-w-xl mx-auto">
                                Contact {shopInfo?.shopName || "us"} for delivery scheduling, area coverage, or any delivery-related queries.
                            </p>
